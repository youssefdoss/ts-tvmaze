...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var shows, formattedShows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_API_URL, "search/shows"), { params: { q: term } })];
                case 1:
                    shows = _a.sent();
                    formattedShows = shows.data.map(function (singleShow) {
                        var _a;
                        var show = singleShow.show;
                        return {
                            id: show.id,
                            name: show.name,
                            summary: show.summary,
                            image: ((_a = show.image) === null || _a === void 0 ? void 0 : _a.medium) || DEFAULT_IMAGE_URL
                        };
                    });
                    return [2 /*return*/, formattedShows];
            }
        });
    });
}
